...
去年，我向 LW 征求了一些关于[间隔重复](https://www.gwern.net/Spaced-repetition)软件（SRS）的建议，这些建议可能对我这个高中教师有用。在我积累了一些在课堂上使用SRS的经验后，我收到了一个要求写一篇后续文章的建议。以下是我的报告。
...
请注意，这不是一个用于确认 SRS 是否“有效”的科学实验。先前的研究已经相当有说服力了，而且我想不出一个实际的方法来运行一个对照组或“蒙蔽”自己。下面是一个非正式的报告，介绍我在 2014-15 学年是如何使用 SRS 的，我对其他可能想尝试 SRS 的人的见解，以及这种经历如何改变我的教学方式。
...
在考察了各种程序，包括类似游戏的 [Memrise](https://www.memrise.com/)，甚至是自己写的简单的SRS之后，**我最终选择了[Anki](http://ankisrs.net/)**，因为它的多平台可用性，云同步和易用性。我还希望有一个程序可以作为我一年中临时制作的 2,000 多张卡片的临时收集箱。（相比之下， Memrise 真正需要的是事先包装好的明确的单元）。
...
事实证明，**简单的卡片是非常重要的**，因为它们可以给那些迫切需要它们的学生带来胜利。当然，在10年级的班级里知道一张6年级水平的卡片并不是什么了不起的成就，但是这一行动会让原本消极的士气上升。它可以成为潮流。我可以在它的基础上再接再厉。一些学生开始把Anki当成他们在课堂上做的事情，即使他们忽略了其他的一切。我可以自信地说出一个学生的名字，我确信我通过了我的课程，仅仅是因为安基。别误会，他只是勉强及格。大多数牌都留在他头上。安基在这里并不是什么灵丹妙药，但它给了他和我一些东西，这是前年他不及格时我们所没有的。
...
由于计划外的原因，我在一个季度开始的时候教了一个单元，直到这个季度结束我才正式测试它们。从历史上看，这将是一场灾难。在这种情况下，效果很好**五个星期以来，Anki是他们唯一一个接触到该单元的人，但事实证明这已经足够了。**因为我在单元早期进行了与预测试相同的测试，所以我有一些数据来支持它。考试全部是多项选择题，分为两部分：第一部分是与单元相关的一般术语和概念。第二部分是更难的阅读理解部分。
