...
谈起关于计算机起源的那些神话，常会提到被称为「黄金年代」的上世纪 60 年代与 70 年代。在那段时间里，许多高瞻远瞩的开拓者都在追逐同一个梦想，即让计算机承载强大的思想工具，也就是能增强人类智力的工具[^1]。这些开拓者中的一位，Alan Kay，在阐述个人电脑的潜力时，总结了他们对这个梦想的乐观愿景：「它（计算机）的使用将会改变整个文明的思想模式」[^2]。
