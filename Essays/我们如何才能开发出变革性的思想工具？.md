...
[^20]: See [here](http://augmentingcognition.com/ltm.html) and [here](http://cognitivemedium.com/srs-mathematics) for more on learning new fields using Anki. The last four paragraphs are adapted from [Augmenting Long-term Memory](http://augmentingcognition.com/ltm.html) (2018). 见[这里](http://augmentingcognition.com/ltm.html)和[这里](http://cognitivemedium.com/srs-mathematics)了解更多关于使用 Anki 学习新领域的情况。最后四段改编自[增强长期记忆](http://augmentingcognition.com/ltm.html) (2018)。
