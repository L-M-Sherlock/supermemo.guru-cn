...
July 2020Illustrated by [Maggie Appleton](https://maggieappleton.com/)
...
最有影响力的书籍超越了它们的书页——超越了它们被阅读的那几个小时——不可磨灭地改变了严肃读者看待世界的方式。很少有书能达到这种超越性的影响，但考虑到它们的物理限制，能做到这一点已经很了不起了。作为一种媒介，书籍没有与读者进行长期交流的直接手段。有形的文本停留在书页上，通常在几个时段内线性地被连续阅读。
...
要想被一本书改变，读者必须做的不仅仅是吸收信息：他们必须沐浴在书中的观点中，将这些观点与他们几周甚至几个月的生活经历联系起来，像戴上一顶新帽子一样尝试书中的心理模式。不幸的是，读者必须自己来推动这个过程。作者不能轻易引导这种持续的感性认识：他们的文字停留在已经被阅读过的页面上。我们如何创造一种媒介，既能完成书的工作，又能摆脱书的时间感的束缚？如何才能创造出**穿越时间的文本**——有能力将作者的经验延长到几周或几个月的文本，在读者慢慢将这些想法融入他们的生活时，继续与他们对话？
...
每年都有数十万学生学习《细胞的分子生物学》。该文本展示了无尽的事实和数字，但其目标不是简单地传递参考材料。该书希望传达一种强烈的意识，即如何像细胞生物学家那样思考——看待问题、现象和自己的方式。例如，它包含了对显微镜技术的细微讨论，但读者在阅读时无法有意义地尝试这些思维方式。读者必须把这本书的观点带入他们在实验室的日常互动中，留意那些与练习有关的时刻，或者赋予作者的建议以意义。这种改变模型是很脆弱的：正确的情况必须在读者对这本书还记忆犹新时出现；他们必须注意到这种情况的相关性；他们必须记住这本书的细节；他们必须反思他们的经验以及它与这本书的观点的关系；如此循环。
...
当我们考虑其他方法时，我们可以从世界上最具变革性的书籍中找到灵感。考虑一下《圣经》和《论语》等文本。随着时间的推移，人们将这些书中的思想融入他们的生活，但不是因为作者这样设计的。这些书之所以有效，是因为它们被丰富的文化活动所包围。每周的布道会和实践社区使读者的思想保持新鲜，并促进与生活经验的持续联系。这是对强大文本的一种强有力的方法，需要读者和组织者的广泛投资。我们不可能为每本书建立大教堂。成熟的读者采用类似的方法来研究不那么崇高的文本，但大多数人缺乏必要的技能、动力和文化背景。我们如何设计文本以更广泛地实现这种做法？
...
引导冥想的智能手机应用程序提供了一种有希望的设计方法。冥想的洞察力是缓慢展开的。通常建议有志者每天练习。经过数周和数月，他们可能开始以不同的方式体验世界。如果你还不能清楚地感知你的呼吸，冥想中的一些概念就没有意义，所以最好在以后再介绍。一本关于冥想的书并不适合这种缓慢展开的方式：其中许多内容最初可能没有意义；随着练习的进展，读者需要一次又一次地重新阅读。但是，引导式冥想应用程序的经验自然会随着时间的推移而扩散。每一天的课程以简短的指导开始和结束。教员在整个练习过程中提供专题提示。间歇性的重复可以使旧的想法在学生的头脑中保持活跃，直到他们准备好参与。与其提供一本装订成册的冥想专著，教员可以在数百天内慢慢展开一个想法。重要的是，这些应用程序是一种大众媒介，就像书籍一样：课程可以被「写」一次，并以低廉的价格重新分配给大量的受众。这种方法可以更普遍地应用吗？
...
为了长期参与一本书的思想，读者必须记住其细节，而[这已经是一个挑战](https://andymatuschak.org/books)。一个有希望的解决方案在于[间隔重复记忆系统](https://augmentingcognition.com/ltm.html)，它允许用户可靠而有效地保留大量的知识。像冥想一样，这些系统涉及到每天的练习：每天，读者通过回顾几十个轻量级的提示来维护他们的记忆库。每个提示都提出了一个详细的问题，比如「 George Miller 的绝对判断跨度描述了哪些类型的刺激？」 每天的会话都是不同的，因为每个提示都会按照自己的时间表重复进行。当用户记住或忘记某个提示的答案时，系统会沿着指数曲线扩大或缩小该提示的重复间隔。这些扩大的间隔使读者能够保持数千条提示的集合，而每天只复习几十条提示。参与者一般都是在本来没用上的时间完成复习，比如排队等候时。
...
尽管这些系统很有效，但还没有被广泛采用。采用的一个重要障碍是，要写出好的提示语是出乎意料的困难。为了探索一个潜在的解决方案，我们创建了一本实验性的量子计算教科书，《[量子国度](https://quantum.country/)》。它是以「[记忆媒介](https://numinous.productions/ttft/)」的方式编写的，将专家撰写的间隔重复提示穿插在阅读体验中。我们的目标是通过支持读者的记忆来帮助他们参与具有挑战性的技术材料。然而，当我们采访读者时，我们注意到定期的复习会话程不仅仅是建立详细的记忆：这种持续的做法也改变了读者与材料的关系，使他们长期保持与材料的联系。这些人并不只是读了一遍书就继续他们的生活了。《量子国度》的复习会话让读者在数周和数月内一次又一次地回到它的想法上。
...
考虑一下《风格要素》，这是 Strunk 和 White 的经典写作入门书。作者用《圣经》中的这个例子证明了平行结构的价值。「心灵贫穷的人有福了，因为天国是他们的。哀哭的人有福了，因为他们必得安慰。温柔的人有福了，因为他们要承受地土」。但是光是读一个例子是不够的。优秀作家的耳朵会自动对这些结构产生警惕。他们注意到创造平行的机会，当类似的短语以不同的方式呈现时，他们会注意到不和谐的现象。培养这种意识需要时间。
...
如果在学习平行结构一周后，读者的复习会话上有这样的提示呢？

> 下面这段话被修改为删除了一个平行结构。你可以怎样改写以增加平行结构？两者在效果上有什么不同？
>
