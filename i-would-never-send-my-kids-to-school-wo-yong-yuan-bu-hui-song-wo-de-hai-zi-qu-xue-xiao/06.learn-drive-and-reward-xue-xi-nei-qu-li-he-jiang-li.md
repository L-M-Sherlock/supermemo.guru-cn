...
与基于平均值的[香农熵](https://en.wikipedia.org/wiki/Entropy_%28information_theory%29%29)不同，学习熵更像是一个趋势平均数，最新的信息将比之前传授的信息具有更高的权重。此外，学习熵植根于支配[记忆巩固](https://supermemo.guru/wiki/Two_component_model_of_memory)的规律，包括[间隔效应](https://supermemo.guru/wiki/Spacing_effect)。
