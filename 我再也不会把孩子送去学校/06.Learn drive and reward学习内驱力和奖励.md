...
由于奖励中心可能涉及快乐的预期，我们更应该把研究的结果看作是[学习内驱力](https://supermemo.guru/wiki/Learn_drive)与快乐相关的一个迹象。正是学习内驱力引发了学习。学习才是令人愉快的。标题应该是「神经成像证实有效的学习是令人愉快的」。换句话说，顺序不是「内驱力->快乐->学习」，而是「内驱力->学习->快乐」。
